...
Before writing the final LB simulator, run `lb_probe_wood.py` to capture the exact Wood/Carrots/Hay starting inventories because the public leaderboard description does not publish those amounts.

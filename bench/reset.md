...
| --- | --- | --- | --- |
| `reset-v2` | `7e58b52cb9d990121b0741a84330a6e0e53263b1` | Empty-state progression; seeds 1, 2, 3 | Pending measurement |

## Results

| Status | Detail |
| --- | --- |
| Pending | No canonical `reset-v2` timing result has been recorded yet. |
...
| Open question | Determine which planner reaches `Unlocks.Leaderboard` fastest with the same production backend. | `reset-v2` pending. |
...
| Step | Action |
| ---: | --- |
| 1 | Check out `7e58b52cb9d990121b0741a84330a6e0e53263b1` or the exact later source commit used for the run. |
